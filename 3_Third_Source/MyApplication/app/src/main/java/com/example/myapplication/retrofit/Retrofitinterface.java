...
public interface Retrofitinterface
{
    ...
    @FormUrlEncoded
    @POST("SaveCoin.php")
    Call<String> saveCoin(@Field("managerEMail") String managerEMail, @Field("userEMail") String userEMail, @Field("amount") int amount);

    @FormUrlEncoded
    @POST("UseCoin.php")
    Call<String> useCoin(@Field("managerEMail") String managerEMail, @Field("userEMail") String userEMail, @Field("amount") int amount);
    ...
    @FormUrlEncoded
    @POST("TradeList.php")
    Call<List<TradeModel>> getTradeList(@Field("EMail") String EMail);
}
