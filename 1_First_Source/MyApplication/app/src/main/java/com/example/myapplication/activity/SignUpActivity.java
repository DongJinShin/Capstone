    ...
    public void setBTNComplete()
    {
        ...
        BTNComplete.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                else if(ETNickname.getText().toString().length() < 3 || ETNickname.getText().toString().length() > 10)
                {
                    dialog = new DialogCustrom(SignUpActivity.this,
                            "Coin Management",
                            "닉네임은 3 ~ 10 자리 사이입니다.",
                ...
                {
                    signUpPresenterInterface.signUp(ETEMail.getText().toString(), ETPassword.getText().toString(), ETNickname.getText().toString());
                }
            }
        });
    }
