...
class DBHelper
{
    ...
    function selectTradeList($EMail)
    {
        ...
        $result = $mysqli -> query("SELECT nz_save_manager_email as FromEMail, nz_save_user_email as DSTEMail, nz_save_amount as amount, nz_save_balance as balance, nz_save_time as time FROM nz_save WHERE nz_save_user_email = '$EMail'");
        ...
        $result = $mysqli -> query("SELECT nz_use_manager_email as FromEMail, nz_use_user_email as DSTEMail, nz_use_amount as amount, nz_use_balance as balance, nz_use_time as time FROM nz_use WHERE nz_use_user_email = '$EMail'");
        while($row = $result->fetch_assoc())
        {
            $row['type'] = 2;
            array_push($resultArray, $row);
        ...
        $result = $mysqli -> query("SELECT nz_gift_from_user_email as FromEMail, nz_gift_dst_user_email as DSTEMail, nz_gift_amount as amount, nz_gift_dst_user_balance as balance, nz_gift_time as time FROM nz_gift WHERE nz_gift_dst_user_email = '$EMail'");
        while($row = $result->fetch_assoc())
        {
            $row['type'] = 3;
            array_push($resultArray, $row);
        ...
        $result = $mysqli -> query("SELECT nz_gift_from_user_email as FromEMail, nz_gift_dst_user_email as DSTEMail, nz_gift_amount as amount, nz_gift_from_user_balance as balance, nz_gift_time as time FROM nz_gift WHERE nz_gift_from_user_email = '$EMail'");
        while($row = $result->fetch_assoc())
        {
            $row['type'] = 3;
            array_push($resultArray, $row);
